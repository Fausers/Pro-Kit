                          ...
                          children: <Widget>[
                            ...
                            SingleChildScrollView(
                              ...
                              child: Row(
                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                children: <Widget>[
                                  category(appCat5, app_ic_phone, snapshot.data.defaultTheme.name, isNew: true, type: snapshot.data.defaultTheme.type, onTap: () {
                                    DTWalkThoughScreen().launch(context);
                                  }),
                                  category(appCat4, app_ic_phone, snapshot.data.widgets.name, isNew: true, type: snapshot.data.widgets.type, onTap: () {
                                    ProKitScreenListing(snapshot.data.widgets).launch(context);
                                  }),
                                  category(appCat1, app_ic_phone, appLblFullApps, type: snapshot.data.fullApp.type, onTap: () {
                                  ...
                                  category(appCat3, app_ic_phone, appLblIntegrations, isNew: true, onTap: () {
