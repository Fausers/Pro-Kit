...
class _SelectionDialogState extends State<SelectionDialog> {
  ...
  Widget build(BuildContext context) => SimpleDialog(
        title: Column(
          ...
          children: <Widget>[
            text("Select Country Code", textColor: t12_text_color_primary, fontSize: 16.0, fontFamily: fontSemibold),
            TextField(
        ...
        children: <Widget>[
          ...
          Expanded(
            ...
            child: Row(
              ...
              children: <Widget>[
                Expanded(child: text(e.toLongString(), fontSize: textSizeMedium, textColor: t12_text_color_primary)),
                text(e.dialCode, fontSize: textSizeMedium, textColor: t12_text_color_primary, fontFamily: fontSemibold),
              ],
            ),
          ),
        ],
