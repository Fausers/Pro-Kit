...
ProTheme getWidgets() {
  ...
  list.add(ProTheme(name: 'Material Widgets', type: 'New', show_cover: false, sub_kits: getMaterialWidgets(), darkThemeSupported: true));
  list.add(ProTheme(name: 'Cupertino Widgets', type: 'New', show_cover: false, sub_kits: getCupertinoWidgets(), darkThemeSupported: true));
  list.add(ProTheme(name: 'Painting and effect Widgets', type: 'New', show_cover: false, sub_kits: getPaintingAndEffectWidgets(), darkThemeSupported: true));
  list.add(ProTheme(name: 'Animation and motion Widgets', type: 'New', show_cover: false, sub_kits: getAnimationAndMotionWidgets(), darkThemeSupported: true));
  list.add(ProTheme(name: 'Interaction Model Widgets', type: 'New', show_cover: false, sub_kits: getInteractionModelWidgets(), darkThemeSupported: true));
  list.add(ProTheme(name: 'Other Widgets', type: 'New', show_cover: false, sub_kits: getOtherWidgets(), darkThemeSupported: true));

  return ProTheme(name: 'Widgets', title_name: 'Widgets', type: 'New', show_cover: false, sub_kits: list);
}
...
ProTheme getDefaultTheme() {
  return ProTheme(name: "Default Theme", title_name: 'Default Theme', type: 'New', show_cover: false, darkThemeSupported: true);
}
//endregion
...
ProTheme getIntegrations() {
  ...
  return ProTheme(name: 'Integration', title_name: 'Integration', type: 'New', show_cover: false, sub_kits: list);
}
...
List<ProTheme> getIntegration() {
  ...
  list.add(ProTheme(name: 'Confitte', show_cover: false, type: '', widget: CHomePage(), darkThemeSupported: true));
...
List<ProTheme> getRestAPi() {
  ...
  list.add(ProTheme(name: 'Get example with FutureBuilder', type: 'New', show_cover: false, widget: GETMethodExampleScreen(), darkThemeSupported: true));
  list.add(ProTheme(name: 'Post example', type: 'New', show_cover: false, widget: PostMethodExampleScreen(), darkThemeSupported: true));
...
ProTheme getWebApps() {
  ...
  return ProTheme(name: 'Web', title_name: 'Flutter Web Apps', type: 'New', show_cover: false, sub_kits: list);
}
